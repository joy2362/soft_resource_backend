                    ...
                    <div class="modal-content">
                        ...
                        <form method="post" enctype="multipart/form-data" id="editCategoryForm">
                            <div class="modal-body">
                                ...
                                <div class="form-group mb-3">
                                    <label for="edit_style" class="form-label">Style</label>
                                    <select class="form-select" id="edit_style" name="style" required>
                                        <option value="">Select Style ...</option>
                                        <option value="horizontal">Horizontal</option>
                                        <option value="vertical">Vertical</option>
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea id="edit_description" class="form-control" name="description" rows="8"></textarea>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.status === 200){
                            ...
                            $('#edit_style').val(response.category.style);
                            $('#edit_description').summernote("code", response.category.brief);
                            $('#edit_heading').val(response.category.heading);
                ...
                $.ajax({
                    ...
                    success: function(response){
                        if(response.status === 400){
                            ...
                            $('#editCategoryForm').find('input[name="style"]').val('');
