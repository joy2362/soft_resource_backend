...
//multi delete item
Route::post('item/multi-delete', [ItemController::class,'multi_delete'])->name('item.multi-delete');
Route::post('item/multi-recover', [TrashController::class,'multi_recover'])->name('item.multi-recover');
//trash
Route::get('recycle-bin', [TrashController::class,'index'])->name('recycle-bin.index');
Route::get('recycle-bin/delete/all', [TrashController::class,'delete_all'])->name('recycle-bin.delete.all');
Route::get('recycle-bin/recover/all', [TrashController::class,'recover_all'])->name('recycle-bin.recover.all');
//recover
